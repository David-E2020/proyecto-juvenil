...
INSERT INTO `cargo` VALUES (1,'administrativo','1'),(2,'gestión social','1'),(3,'gestion social departamental','1'),(4,'Directora de recursos humanos','1'),(5,'director depto informática','1'),(6,'Sub director de depto informática','1'),(7,'asd','1'),(8,'administrativo 3','1'),(9,'administrativo 4','1');
...
INSERT INTO `cliente` VALUES (1,'0','metal mecanica sumi','741585224'),(2,'0','el arriero','74485241'),(7,'1','Entel SA.','74582475'),(8,'0','Tigo SA','74585248585'),(9,'0','Viva SA','145558968'),(10,'1','Cotel tv SA','455845885'),(11,'0','Criss SRL','414527528'),(12,'1','Huawei SA','45521854'),(13,'1','Huawei SA','45521854'),(14,'1','Motorola','41524785'),(15,'1','Ipple','45247854'),(16,'1','Cafe alexander SA','85441255'),(17,'1','Ingala SA','4145255225'),(18,'0','Bolivia-Mar Sa','71777177');
...
CREATE TABLE `detalle_compra` (
  ...
  `cantidadcompra` int(10) unsigned DEFAULT NULL,
...
INSERT INTO `producto` VALUES (3,7,'poleras','poleras talla M',50.00,65.00,20,'2021-03-25','1'),(4,8,'televisores','',1200.00,1400.00,3,'2021-03-25','1'),(5,9,'celulares','',4500.00,4900.00,5,'2021-03-25','1');
...
INSERT INTO `proveedor` VALUES (7,'deep web','Juan carlos','dee.web@gmail.onion','7415244','no definido','1','deep-web.png'),(8,'lg','Monica Casas','monica@gmail.com','74158444','los pinos N° 555','1','lg.jpg'),(9,'const','dacas','asd@gmail.com','555555','cala coto N°110','1','constuct.jpg');
...
-- Dump completed on 2021-04-09 23:42:04
